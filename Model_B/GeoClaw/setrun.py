...
#------------------------------
    ...
    clawdata.lower[0] = 23.0      # west longitude
    ...
    clawdata.num_cells[0] = 140 #120 #30
    clawdata.num_cells[1] = 140 #120 #30
    ...
    rundata.regiondata.regions.append([3, 3, 0., sim_time, clawdata.lower[0], clawdata.upper[0], clawdata.lower[1], clawdata.upper[1]])
    rundata.regiondata.regions.append([6, 6, 0., sim_time, 26, 27.5, 37.5, 38.5])
    ...
    if clawdata.output_style==2:
        ...
        rundata.gaugedata.gauges.append([14, 25.158539, 35.349954, 0., sim_time]) #HRAK - shifted
        ...
        rundata.gaugedata.gauges.append([13, 26.928750, 35.422989, 0., sim_time]) #NOA-03 - shifted
        rundata.gaugedata.gauges.append([15, 26.706, 37.802, 0., sim_time]) #syn1
        rundata.gaugedata.gauges.append([16, 26.745, 37.814, 0., sim_time]) #syn2
        rundata.gaugedata.gauges.append([17, 26.961, 37.770, 0., sim_time]) #syn3
        rundata.gaugedata.gauges.append([18, 26.834, 38.119, 0., sim_time]) #syn4
        rundata.gaugedata.gauges.append([19, 26.765, 38.196, 0., sim_time]) #syn5
        rundata.gaugedata.gauges.append([20, 26.654, 38.205, 0., sim_time]) #syn6
        rundata.gaugedata.gauges.append([21, 26.391, 38.252, 0., sim_time]) #syn7
    ...
    geo_data.friction_depth = 200 #1e6
    geo_data.rho = 1020.0
    ...
    topo_data.topofiles.append([3, 'bay.tt3'])

    # == setdtopo.data values ==
    dtopo_data = rundata.dtopo_data
    # for moving topography, append lines of the form :   (<= 1 allowed for now!)
    #   [topotype, fname]
    dtopo_path = 'cattapered_Fra_v4_noWL_0.005_tanioka.nc.tt3'
    ...
    rundata.fgmax_data.num_fgmax_val = 5  # Save depth and speed and hmin
    ...
    dx_fine = 2./(26.*4.)  # grid resolution at finest level

    fg = fgmax_tools.FGmaxGrid()
    fg.point_style = 2  # uniform rectangular x-y grid
    fg.x1 = 23 + dx_fine/2.  # specify pts to align with FV cell centers
    fg.x2 = 28 - dx_fine/2.
    fg.y1 = 35 + dx_fine/2.
    fg.y2 = 40 - dx_fine/2.
    fg.dx = dx_fine
    fg.tstart_max =  15.      # when to start monitoring max values
    ...
    fgout.nx = 400*5
    fgout.ny = 400*5
    fgout.x1 = 23  # specify edges (fgout pts will be cell centers)
    fgout.x2 = 28
    fgout.y1 = 35
    fgout.y2 = 40
    fgout.tstart = 15.
    fgout.tend = sim_time
    fgout.nout = int(sim_time/60+1)
