...
python /import/freenas-m-05-seissol/kutschera/HIWI/Scripts/Script4Processing/extractDataFromUnstructuredOutput.py /import/freenas-m-05-seissol/kutschera/MAthesis_fkutschera/simulations/Samos_final_Fra_v4/${input}-surface.xdmf --Data u1 u2 u3 --idt $(seq 0 100) --backend hdf5
